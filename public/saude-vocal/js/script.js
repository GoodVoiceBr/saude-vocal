...
$(document).ready(function () {
    ...
    $('#cadastro_btn').click(function () {
        ...
        let password = $('#senha_cadastro_input').val();
        let confirmPassword = $('#confirmar_senha_input').val();

        cadastro(email, password, confirmPassword).then(function (value) {
            if (value[0] == false) {
                $("#erro_cadastro").html(value[1]);
                $("#erro_cadastro").show();
            } else {
                $('#tela_cadastro').hide();
            }
    ...
    $('#cadastre_btn').click(function () {
        $('#tela_cadastro').show();
        $('#tela_login').hide();
    });

    $('#cancela_btn').click(function () {
        $('#tela_login').show();
        $('#tela_cadastro').hide();
    });
